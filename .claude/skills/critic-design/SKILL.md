...
Then **read and follow** `/workspace/.claude/skills/ui-ux-pro-max/SKILL.md` and implement the brief in priority order. After implementing, optionally re-run this critic skill to verify.
